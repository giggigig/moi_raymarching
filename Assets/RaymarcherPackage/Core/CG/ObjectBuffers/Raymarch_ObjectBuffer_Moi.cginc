...
float4 MAS_ShapeGenerator(float3 center)
{
   ...
   float4 obj7 = GEN_FRAC_Apollonian(center,size7.xyz,_obj7Model,color7);
...
//Groups of obj3
   float4 group0 = OP_SmoothSubtraction(obj5,obj3,obj5sm);
...
//-----Registered Final Groups & Single Objects
   float4 group1 = OP_SmoothUnion(group0,obj0,_MASrenderSmoothness);
   float4 group2 = OP_SmoothUnion(group1,obj1,_MASrenderSmoothness);
   float4 group3 = OP_SmoothUnion(group2,obj2,_MASrenderSmoothness);
   float4 group4 = OP_SmoothUnion(group3,obj4,_MASrenderSmoothness);
