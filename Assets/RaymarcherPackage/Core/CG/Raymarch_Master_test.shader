Shader "Matej Vanco/RayMarcher/PC/RM Master_test"
{
	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_test.cginc"

				#include "Includes\PC\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_test.cginc"	
