Shader "Matej Vanco/RayMarcher/PC/RM Master_test 2"
{
	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_test 2.cginc"

				#include "Includes\PC\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_test 2.cginc"	
